...
Layout = TypedDict(
    "Layout", {"cols": Sequence[float], "rows": Sequence[float], "cells": Sequence[Sequence[int]]}
)
...
class View:
    ...
    def size(self) -> int: ...
    def begin_edit(
        self, edit_token: int, cmd: str, args: Optional[Dict[str, Any]] = ...
    ) -> Edit: ...
    ...
    def add_regions(
        self, key: str, regions: List[Region], scope: str = ..., icon: str = ..., flags: int = ...
    ) -> None: ...
...
class Phantom:
    ...
    id: int
    def __init__(
        self, region: Region, content: str, layout: int, on_navigate: Optional[Callback1[str]] = ...
    ) -> None: ...
    def __eq__(self, rhs: Any) -> bool: ...
