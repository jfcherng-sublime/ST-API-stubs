from typing import Any, Optional, Callable, Sequence, Tuple, Union, List, Dict, Sized


# Location: contains information about a location of a symbol. The first string
...
# Layout: a dict such as {"cols": [0, 0.5, 1], "rows": [0, 0.5, 1],
# "cells": [[0, 0, 1, 2], [1, 0, 2, 1], [1, 1, 2, 2]]}
Layout = Dict[str, Union[List[float], List[List[int]]]]
# Vector: represents x and y coordinates
...
def encodevalue(val: Value, pretty: bool = ...) -> str: ...
def decodevalue(data: str) -> Value: ...
def expand_variables(val: Union[str, List[str], Dict[Any, str]], variables: dict) -> Union[str, List[str], Dict[Any, str]]: ...
...
class Window:
    ...
    def show_input_panel(self, caption: str, initial_text: str, on_done: Callable, on_change: Callable, on_cancel: Callable) -> View: ...

    def show_quick_panel(self, items: Union[List[str], List[List[str]]], on_select, flags: int = ..., selected_index: int = ..., on_highlight: Optional[Callable] = ...) -> None: ...
...
class View:
    ...
    def begin_edit(self, edit_token, cmd, args: Optional[Dict[str, Any]] = ...): ...
    ...
    def find_all(self, pattern: str, flags: int = ...,
                 fmt: Optional[str] = ..., extractions: Optional[List] = ...) -> List[Vector]: ...
    ...
    def text_tolayout(self, tp: int) -> Vector: ...

    def layout_to_text(self, xy: Vector): ...

    def window_tolayout(self, xy: Vector) -> Vector: ...
    ...
    def show_popup(self, content: str, flags: int = ..., location: int = ..., max_width: int = ...,
                   max_height: int = ..., on_navigate: Optional[Callable] = ..., on_hide: Optional[Callable] = ...) -> None: ...
